...
const Footer = () => {
    return (
        <footer className='bg-[#0d0d1a] text-white pt-40'>
            {/* Logo */}
            ...
            {/* 3 Column Grid */}
            <div className='container mx-auto grid grid-cols-3 gap-10 pb-10 px-6'>
                ...
                <div>
                    ...
                    <p className='text-white/60 text-sm mb-4'>Subscribe to our newsletter for the latest updates.</p>
                    <div className='flex'>
                        <input
                            type='email'
                        ...
                        />
                        <button className='bg-gradient-to-r from-yellow-400 to-pink-500 text-black font-bold px-5 py-2 rounded-r-full text-sm'>
                            Subscribe
                        </button>
                    </div>
                </div>
            ...
            {/* Bottom Bar */}
            <div className='border-t border-white/10 text-center py-5 text-white/50 text-sm'>
